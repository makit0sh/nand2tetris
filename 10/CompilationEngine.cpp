...
void CompilationEngine::setFileName(std::string fileName)
{
    currentFunctionName = "";
...
void CompilationEngine::writeArithmetic(std::string command)
{
    if (command == "add") {
        *ofs << "@SP" << std::endl;
        *ofs << "A=M" << std::endl;
...
void CompilationEngine::writePushPop(CommandType command, std::string segment, int index)
{
    if (command== C_PUSH) {
        if (segment == "constant") {
            *ofs << "@" << index << std::endl;
...
void CompilationEngine::writeInit()
{
...
void CompilationEngine::writeLabel(std::string label)
{
    *ofs << "(" << currentFunctionName << "$" << label << ")" << std::endl;
}

void CompilationEngine::writeGoto(std::string label)
{
    *ofs << "@" << currentFunctionName << "$" << label << std::endl;
    *ofs << "0;JMP" << std::endl;
}

void CompilationEngine::writeIf(std::string label)
{
...
void CompilationEngine::writeCall(std::string functionName, int numArgs)
{
...
void CompilationEngine::writeReturn()
{
    *ofs << "@LCL" << std::endl;
    *ofs << "D=M" << std::endl;
...
void CompilationEngine::writeFunction(std::string functionName, int numLocals)
{
